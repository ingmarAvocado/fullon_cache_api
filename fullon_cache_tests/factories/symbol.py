...
class SymbolFactory:
    ...
    def create_spot_symbol(
        self, base: str = "BTC", quote: str = "USDT", **kwargs
    ) -> ORMSymbol:
        ...
        """
        return self.create(
            symbol=f"{base}/{quote}", base=base, quote=quote, futures=False, **kwargs
        )
    ...
    def create_exchange_symbols(
        self, exchanges: list, symbol_name: str = "BTC/USDT"
    ) -> dict:
        ...
        for i, exchange in enumerate(exchanges):
            symbol = self.create(
                symbol=symbol_name, exchange_name=exchange, cat_ex_id=i + 1
            )
